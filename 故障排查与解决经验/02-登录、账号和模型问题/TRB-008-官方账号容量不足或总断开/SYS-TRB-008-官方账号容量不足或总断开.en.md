...
| `E02` | User-provided incident record | 2026-09-17 | Investigation sequence, excluded directions, and evidence boundary | Private | `90-本地草稿/TRB-008-官方账号容量和断流/事件经过.md` |
| `E03` | User-provided external-feedback text | 2026-09-17 | Support-submission text, secret boundary, and regression criteria | Private | `90-本地草稿/TRB-008-官方账号容量和断流/发给官方的话.md` |
